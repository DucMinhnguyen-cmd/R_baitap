...
#  Mỗi điểm là 1 cụm riêng (N cụm)
#Tính khoảng cách giữa TẤT CẢ cặp cụm
#Gộp 2 cụm gần nhất
#Lặp bước 2-3 cho đến khi còn 1 cụm
#Minh họa quá trình:
set.seed(42)
